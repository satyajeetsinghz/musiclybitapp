...
const MainContent: React.FC<MainContentProps> = ({ setFavoriteAlbums, favoriteAlbums }) => {
    ...
    return (
        <div className="w-[70%] max-md:w-full max-h-[90%] max-md:max-h-full max-md:px-1 bg-neutral-900 text-white rounded-md relative">
            ...
            {/* Popup Notification */}
            {popupMessage && (
                <div className="absolute top-[80%] md:bottom-[20px] left-1/2 transform -translate-x-1/2 bg-white text-black text-sm max-xs:text-xs max-xs:min-w-max lg:text-base font-semibold px-4 py-2 rounded-lg flex items-center gap-2 shadow-lg transition-opacity duration-500 z-50">
