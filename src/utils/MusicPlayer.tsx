...
const MusicPlayer = () => {
    ...
    return (
        <div className="w-full h-20 bg-neutral-900 fixed bottom-0 flex justify-between items-center px-2 py-1">
            ...
            {/* Player Controls  */}
            <div className="w-[55%] sm:w-[40%] h-20 px-1 py-2 bg-ellow-400 flex flex-col justify-center sm:justify-self-auto items-center">
