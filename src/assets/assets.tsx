...
export const albums = [
  {
    ...
    songs: [
      { id: "1" ,title: "Shape of You", artist: "Ed Sheeran", audio: "/assets/music/shape-of-you.mp3", image: "https://i.pinimg.com/originals/88/3b/2c/883b2c50f85db0b3af2ab8bbc610e4e4.jpg", dateAdded: "Dec 10,2021" },
      { id: "2" ,title: "Perfect", artist: "Ed Sheeran", audio: "/assets/music/perfect.mp3", dateAdded: "Dec 10,2021" },
    ],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    name: "God's Plan",
    artist: "Drake",
    image: "/assets/music-cover/gods-plan.jpg",
    songs: [
      { id: "1", title: "God's Plan", artist: "Ed Sheeran", audio: "/assets/music/gods-plan.mp3" },
      { id: "2", title: "In My Feelings", artist: "Ed Sheeran", audio: "/assets/music/in-my-feelings.mp3" },
    ],
  },
];
